...
<p align="left">
  ...
  <a href="https://developer.apple.com/xcode/swiftui/" target="_blank"><img src="https://img.shields.io/badge/SwiftUI-F05138?style=for-the-badge&logo=swift&logoColor=white" alt="SwiftUI"></a>
</p>
...
<p align="left">
  ...
  <a href="https://learn.microsoft.com/en-us/dotnet/csharp/" target="_blank"><img src="https://img.shields.io/badge/C%23-512BD4?style=for-the-badge&logo=c-sharp&logoColor=white" alt="C#"></a>
...
- Diseñé y mantuve una **API RESTful con Node.js**, optimizando consultas SQL para mejorar el rendimiento de una aplicación web interna.
- Participé en el ciclo de vida completo de una **aplicación de gestión de averías**: desde los componentes de interfaz (HTML, CSS, JavaScript) hasta la lógica de servidor (Node.js).
- Trabajé en entorno de equipo con metodologías ágiles y control de versiones con Git.

---

## 💡 Intereses

- 🤖 **IA y Automatización** — Exploro cómo la inteligencia artificial puede simplificar procesos y potenciar el desarrollo de software.
- ⚙️ **Hardware y Sistemas** — Disfruto montando equipos, configurando servidores y entendiendo la tecnología desde sus cimientos físicos.
