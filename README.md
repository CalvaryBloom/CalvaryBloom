...
-   **Desarrollo Web:** Creación y mantenimiento de una web completa utilizando **Node.js** y **SQL**.
-   **Aplicación Full-Stack:** Participación en el diseño y desarrollo de una app para gestionar averías, implementando el frontend con **Node.js** y el backend con **JavaScript**.
